...
(declaim (special *browse-html-style*))

(setf (documentation '*browse-html-style* 'variable)
...
(autoload update-pax-world "mgl-pax/document" :lambda-list
...
(declaim (special *document-html-max-navigation-table-of-contents-level*))

(setf (documentation '*document-html-max-navigation-table-of-contents-level*
                     'variable)
...
(declaim (special *document-html-bottom-blocks-of-links*))

(setf (documentation '*document-html-bottom-blocks-of-links* 'variable)
        "Like *DOCUMENT-HTML-TOP-BLOCKS-OF-LINKS*, only it is displayed
  below the table of contents.")

(export '*document-html-bottom-blocks-of-links* "MGL-PAX")

(declaim (special *document-html-top-blocks-of-links*))

(setf (documentation '*document-html-top-blocks-of-links* 'variable)
...
(declaim (special *document-html-sidebar*))

(setf (documentation '*document-html-sidebar* 'variable)
...
(declaim (special *document-html-head*))

(setf (documentation '*document-html-head* 'variable)
...
(declaim (special *document-html-charset*))

(setf (documentation '*document-html-charset* 'variable)
...
(declaim (special *document-html-lang*))

(setf (documentation '*document-html-lang* 'variable)
        "The value for the `html` element's `xml:lang` and `lang`
  attributes in the generated HTML.")

(export '*document-html-lang* "MGL-PAX")

(autoload update-asdf-system-html-docs "mgl-pax/document" :lambda-list
...
(declaim (special *document-html-default-style*))

(setf (documentation '*document-html-default-style* 'variable)
...
(autoload update-asdf-system-readmes "mgl-pax/document" :lambda-list
...
(declaim (special *document-base-url*))

(setf (documentation '*document-base-url* 'variable)
...
(autoload print-dref-bullet "mgl-pax/document" :lambda-list '(dref stream)
          :docstring nil)

(declaim (special *document-mark-up-signatures*))

(setf (documentation '*document-mark-up-signatures* 'variable)
...
(declaim (special *document-min-link-hash-length*))

(setf (documentation '*document-min-link-hash-length* 'variable)
...
(declaim (special *document-url-versions*))

(setf (documentation '*document-url-versions* 'variable)
...
(declaim (special *document-fancy-html-navigation*))

(setf (documentation '*document-fancy-html-navigation* 'variable)
...
(declaim (special *document-text-navigation*))

(setf (documentation '*document-text-navigation* 'variable)
...
(declaim (special *document-max-table-of-contents-level*))

(setf (documentation '*document-max-table-of-contents-level* 'variable)
...
(declaim (special *document-max-numbering-level*))

(setf (documentation '*document-max-numbering-level* 'variable)
...
(declaim (special *document-link-sections*))

(setf (documentation '*document-link-sections* 'variable)
...
(declaim (special *document-hyperspec-root*))

(setf (documentation '*document-hyperspec-root* 'variable)
...
(setf (documentation '*document-link-to-hyperspec* 'variable)
...
(declaim (special *document-link-code*))

(setf (documentation '*document-link-code* 'variable)
        "Whether definitions of things other than [SECTION][class]s
  are allowed to be @LINKABLE.")

(export '*document-link-code* "MGL-PAX")

(autoload prin1-to-markdown "mgl-pax/document" :lambda-list
...
(autoload downcasingp "mgl-pax/document" :lambda-list 'nil :docstring nil)

(declaim (special *document-downcase-uppercase-code*))

(setf (documentation '*document-downcase-uppercase-code* 'variable)
...
(declaim (special *document-uppercase-is-code*))

(setf (documentation '*document-uppercase-is-code* 'variable)
...
(autoload doctitle "mgl-pax/document" :lambda-list '(object) :docstring
...
(autoload document-docstring "mgl-pax/document" :lambda-list
...
(declaim (special *document-tight*))

(setf (documentation '*document-tight* 'variable)
...
(autoload call-with-heading "mgl-pax/document" :lambda-list
          '(stream dref link-title-to fn) :docstring nil)

(declaim (special *document-pandoc-pdf-header-includes*))

(setf (documentation '*document-pandoc-pdf-header-includes* 'variable)
...
(declaim (special *document-pandoc-pdf-metadata-block*))

(setf (documentation '*document-pandoc-pdf-metadata-block* 'variable)
...
(declaim (special *document-pandoc-pdf-options*))

(setf (documentation '*document-pandoc-pdf-options* 'variable)
...
(declaim (special *document-pandoc-program*))

(setf (documentation '*document-pandoc-program* 'variable)
        "The name of the Pandoc binary. It need not be an absolute pathname
  as `\\\\PATH` is searched.")

(export '*document-pandoc-program* "MGL-PAX")

(autoload escape-tex "mgl-pax/document" :lambda-list '(string) :docstring
          "Construct a new string from STRING by adding a backslash before
  special TeX characters

      &%$#_{}~^\\")

(export 'escape-tex "MGL-PAX")

(autoload escape-markdown "mgl-pax/document" :lambda-list
...
(autoload ensure-transcribe-loaded "mgl-pax/transcribe" :lambda-list 'nil
          :docstring nil)

(autoload delete-comments "mgl-pax/transcribe" :lambda-list
...
(autoload delete-trailing-whitespace "mgl-pax/transcribe" :lambda-list
          '(string) :docstring
...
(autoload squeeze-whitespace "mgl-pax/transcribe" :lambda-list '(string)
          :docstring
...
(autoload transcribe "mgl-pax/transcribe" :lambda-list
...
(declaim (special *transcribe-check-consistency*))

(setf (documentation '*transcribe-check-consistency* 'variable)
        "The default value of TRANSCRIBE's CHECK-CONSISTENCY argument.")

(export '*transcribe-check-consistency* "MGL-PAX")

(declaim (special *transcribe-syntaxes*))

(setf (documentation '*transcribe-syntaxes* 'variable)
...
(autoload standard-transcribe-dynenv "mgl-pax/transcribe" :lambda-list '(fn)
          :docstring
...
(autoload ensure-web-server "mgl-pax/web" :lambda-list
          '(&key port hyperspec-root) :docstring
