...
`SECTION`([`0`][5fac] [`1`][672f])s is generated on the fly, complete with [Codification][f1ab] and
[links][1865].
...
in Emacs) will be shown with the documentation of the [`MGL-PAX`][6fdb]
package and the [`MGL-PAX`][6fdb] asdf:system. One may then follow the links
on the page to navigate to a page with the documentation the desired
definition. Alternatively, a [locative][4d92] may be specified as in
`MGL-PAX package`
...
definition of [`DEFSECTION`][72b4] in the page documenting the entire
[PAX Manual][2415]:
...
#### 9.2.2 Navigating the Documentation in W3M
...
- [reader] **GLOSSARY-TERM-TITLE** *GLOSSARY-TERM (:TITLE)*
  ...
  [796d]: #x-28MGL-PAX-3A-40NAVIGATION-IN-W3M-20MGL-PAX-3ASECTION-29 "Navigating the Documentation in W3M"
