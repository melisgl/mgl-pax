...
PAX is built on top of the DRef library. See <https://github.com/melisgl/dref>.
...
`#'PRINT`), a definition such as `(DREF 'PRINT 'FUNCTION)`, a
...
Also, by registering in [PAX World][1281], you get documentation generated
...
[`MAKE-GIT-SOURCE-URI-FN`][587f]), the commit id is in the link. This means
...
[`REGISTER-DOC-IN-PAX-WORLD`][f4fd] in your ASDF system and file an issue at
