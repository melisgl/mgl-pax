<a id='x:28MGL-PAX::40PAX-MANUAL:20MGL-PAX:SECTION:29'></a>
...
- [2 Background][dee3]
- [3 Tutorial][23ee]
- [4 Emacs Integration][9a25]
- [5 Basics][2200]
- [6 Markdown Support][a90e]
    - [6.1 Indentation][5a7b]
    - [6.2 Syntax highlighting][8b71]
- [7 Documentation Printer Variables][2eba]
- [8 Locative Types][9f14]
- [9 Extension API][8e44]
    - [9.1 Locatives and References][a741]
    - [9.2 Adding New Object Types][0411]
    - [9.3 Reference Based Extensions][ff65]
    - [9.4 Sections][36e1]
...
<a id='x:28MGL-PAX::40PAX-BACKGROUND:20MGL-PAX:SECTION:29'></a>
...
<a id='x:28MGL-PAX::40PAX-TUTORIAL:20MGL-PAX:SECTION:29'></a>
...
fanciness in [Emacs Integration][9a25]. Generating documentation from
...
definitions tied to symbols. See [Locative Types][9f14].

<a id='x:28MGL-PAX::40PAX-EMACS-INTEGRATION:20MGL-PAX:SECTION:29'></a>
...
<a id='x:28MGL-PAX::40PAX-BASICS:20MGL-PAX:SECTION:29'></a>

## 5 Basics

Now let's examine the most important pieces in detail.

<a id='x:28MGL-PAX:DEFSECTION:20MGL-PAX:MACRO:29'></a>
...
- [macro] **DEFSECTION** *NAME (&KEY (PACKAGE \*PACKAGE\*) (EXPORT T) TITLE (DISCARD-DOCUMENTATION-P \*DISCARD-DOCUMENTATION-P\*)) &BODY ENTRIES*
    ...
    bound to a [`SECTION`][aee8] object. By convention, section names start
    with the character @. See [Tutorial][23ee] for an example.
    ...
    arguments. See [Locative Types][9f14] for the list of locative types
    ...
    [Extension API][8e44]) until documentation is generated, so it is allowed
...
<a id='x:28MGL-PAX::2ADISCARD-DOCUMENTATION-P:2A:20VARIABLE:29'></a>
...
<a id='x:28MGL-PAX:DEFINE-PACKAGE:20MGL-PAX:MACRO:29'></a>
...
<a id='x:28MGL-PAX:DOCUMENT:20FUNCTION:29'></a>
...
- [function] **DOCUMENT** *OBJECT &KEY STREAM PAGES (FORMAT :MARKDOWN)*
    ...
    for which [`DOCUMENT-OBJECT`][a05e] is defined. To look up the documentation
    of function [`DOCUMENT`][1eb8]:
    ...
    generated, see [Documentation Printer Variables][2eba].
...
<a id='x:28MGL-PAX::40PAX-MARKDOWN-SUPPORT:20MGL-PAX:SECTION:29'></a>
...
<a id='x:28MGL-PAX::40PAX-MARKDOWN-INDENTATION:20MGL-PAX:SECTION:29'></a>
...
<a id='x:28MGL-PAX::40PAX-MARKDOWN-SYNTAX-HIGHLIGHTING:20MGL-PAX:SECTION:29'></a>
...
<a id='x:28MGL-PAX::40PAX-DOCUMENTATION-PRINTER-VARIABLES:20MGL-PAX:SECTION:29'></a>
...
<a id='x:28MGL-PAX::2ADOCUMENT-UPPERCASE-IS-CODE:2A:20VARIABLE:29'></a>
...
<a id='x:28MGL-PAX::2ADOCUMENT-LINK-CODE:2A:20VARIABLE:29'></a>
...
<a id='x:28MGL-PAX::2ADOCUMENT-LINK-SECTIONS:2A:20VARIABLE:29'></a>
...
<a id='x:28MGL-PAX::2ADOCUMENT-MIN-LINK-HASH-LENGTH:2A:20VARIABLE:29'></a>
...
<a id='x:28MGL-PAX::2ADOCUMENT-MARK-UP-SIGNATURES:2A:20VARIABLE:29'></a>
...
<a id='x:28MGL-PAX::2ADOCUMENT-MAX-NUMBERING-LEVEL:2A:20VARIABLE:29'></a>
...
<a id='x:28MGL-PAX::2ADOCUMENT-MAX-TABLE-OF-CONTENTS-LEVEL:2A:20VARIABLE:29'></a>
...
<a id='x:28MGL-PAX::2ADOCUMENT-TEXT-NAVIGATION:2A:20VARIABLE:29'></a>
...
<a id='x:28MGL-PAX::2ADOCUMENT-FANCY-HTML-NAVIGATION:2A:20VARIABLE:29'></a>
...
<a id='x:28MGL-PAX::2ADOCUMENT-NORMALIZE-PACKAGES:2A:20VARIABLE:29'></a>
...
<a id='x:28MGL-PAX::40PAX-LOCATIVE-TYPES:20MGL-PAX:SECTION:29'></a>
...
<a id='x:28ASDF:2FSYSTEM:SYSTEM:20MGL-PAX:LOCATIVE:29'></a>
...
<a id='x:28MGL-PAX:SECTION:20MGL-PAX:LOCATIVE:29'></a>

- [locative] **SECTION**

    Refers to a section defined by [`DEFSECTION`][2863].

<a id='x:28VARIABLE:20MGL-PAX:LOCATIVE:29'></a>
...
<a id='x:28MGL-PAX:CONSTANT:20MGL-PAX:LOCATIVE:29'></a>
...
<a id='x:28MGL-PAX:MACRO:20MGL-PAX:LOCATIVE:29'></a>

- [locative] **MACRO**

<a id='x:28COMPILER-MACRO:20MGL-PAX:LOCATIVE:29'></a>

- [locative] **COMPILER-MACRO**

<a id='x:28FUNCTION:20MGL-PAX:LOCATIVE:29'></a>
...
<a id='x:28GENERIC-FUNCTION:20MGL-PAX:LOCATIVE:29'></a>

- [locative] **GENERIC-FUNCTION**

<a id='x:28METHOD:20MGL-PAX:LOCATIVE:29'></a>
...
<a id='x:28MGL-PAX:ACCESSOR:20MGL-PAX:LOCATIVE:29'></a>
...
<a id='x:28MGL-PAX:READER:20MGL-PAX:LOCATIVE:29'></a>
...
<a id='x:28MGL-PAX:WRITER:20MGL-PAX:LOCATIVE:29'></a>
...
<a id='x:28MGL-PAX:STRUCTURE-ACCESSOR:20MGL-PAX:LOCATIVE:29'></a>
...
<a id='x:28CLASS:20MGL-PAX:LOCATIVE:29'></a>

- [locative] **CLASS**

<a id='x:28CONDITION:20MGL-PAX:LOCATIVE:29'></a>

- [locative] **CONDITION**

<a id='x:28TYPE:20MGL-PAX:LOCATIVE:29'></a>
...
<a id='x:28PACKAGE:20MGL-PAX:LOCATIVE:29'></a>

- [locative] **PACKAGE**

<a id='x:28MGL-PAX:LOCATIVE:20MGL-PAX:LOCATIVE:29'></a>
...
<a id='x:28MGL-PAX::40PAX-EXTENSION-API:20MGL-PAX:SECTION:29'></a>

## 9 Extension API

<a id='x:28MGL-PAX::40PAX-LOCATIVES-AND-REFERENCES:20MGL-PAX:SECTION:29'></a>
...
<a id='x:28MGL-PAX:LOCATE:20FUNCTION:29'></a>
...
<a id='x:28MGL-PAX:LOCATE-ERROR:20CONDITION:29'></a>
...
<a id='x:28MGL-PAX:LOCATE-ERROR-MESSAGE:20:28MGL-PAX:READER:20MGL-PAX:LOCATE-ERROR:29:29'></a>

- [reader] **LOCATE-ERROR-MESSAGE** *LOCATE-ERROR*

<a id='x:28MGL-PAX:LOCATE-ERROR-OBJECT:20:28MGL-PAX:READER:20MGL-PAX:LOCATE-ERROR:29:29'></a>

- [reader] **LOCATE-ERROR-OBJECT** *LOCATE-ERROR*

<a id='x:28MGL-PAX:LOCATE-ERROR-LOCATIVE:20:28MGL-PAX:READER:20MGL-PAX:LOCATE-ERROR:29:29'></a>

- [reader] **LOCATE-ERROR-LOCATIVE** *LOCATE-ERROR*

<a id='x:28MGL-PAX:RESOLVE:20FUNCTION:29'></a>
...
<a id='x:28MGL-PAX:REFERENCE:20CLASS:29'></a>
...
<a id='x:28MGL-PAX:REFERENCE-OBJECT:20:28MGL-PAX:READER:20MGL-PAX:REFERENCE:29:29'></a>

- [reader] **REFERENCE-OBJECT** *REFERENCE*

<a id='x:28MGL-PAX:REFERENCE-LOCATIVE:20:28MGL-PAX:READER:20MGL-PAX:REFERENCE:29:29'></a>

- [reader] **REFERENCE-LOCATIVE** *REFERENCE*

<a id='x:28MGL-PAX:MAKE-REFERENCE:20FUNCTION:29'></a>

- [function] **MAKE-REFERENCE** *OBJECT LOCATIVE*

<a id='x:28MGL-PAX:LOCATIVE-TYPE:20FUNCTION:29'></a>
...
<a id='x:28MGL-PAX:LOCATIVE-ARGS:20FUNCTION:29'></a>
...
<a id='x:28MGL-PAX::40PAX-NEW-OBJECT-TYPES:20MGL-PAX:SECTION:29'></a>

### 9.2 Adding New Object Types

One may wish to make the [`DOCUMENT`][1eb8] function and M-. navigation work
with new object types. Extending [`DOCUMENT`][1eb8] can be done by defining a
[`DOCUMENT-OBJECT`][a05e] method. To allow these objects to be referenced from
[`DEFSECTION`][2863] a [`LOCATE-OBJECT`][acc9] method is to be defined. Finally, for M-.
[`FIND-SOURCE`][b417] can be specialized. Finally, [`EXPORTABLE-LOCATIVE-TYPE-P`][96c5]
may be overridden if exporting does not makes sense. Here is a
stripped down example of how all this is done for [`ASDF:SYSTEM:`][90f2]
...
<a id='x:28MGL-PAX:DEFINE-LOCATIVE-TYPE:20MGL-PAX:MACRO:29'></a>
...
<a id='x:28MGL-PAX:EXPORTABLE-LOCATIVE-TYPE-P:20GENERIC-FUNCTION:29'></a>
...
<a id='x:28MGL-PAX:LOCATE-OBJECT:20GENERIC-FUNCTION:29'></a>
...
<a id='x:28MGL-PAX:LOCATE-ERROR:20FUNCTION:29'></a>
...
<a id='x:28MGL-PAX:CANONICAL-REFERENCE:20GENERIC-FUNCTION:29'></a>

- [generic-function] **CANONICAL-REFERENCE** *OBJECT*

    Return a [`REFERENCE`][cc37] that resolves to `OBJECT`.

<a id='x:28MGL-PAX:COLLECT-REACHABLE-OBJECTS:20GENERIC-FUNCTION:29'></a>
...
<a id='x:28MGL-PAX:COLLECT-REACHABLE-OBJECTS:20:28METHOD:20NIL:20:28T:29:29:29'></a>
...
<a id='x:28MGL-PAX:DOCUMENT-OBJECT:20GENERIC-FUNCTION:29'></a>
...
<a id='x:28MGL-PAX:DOCUMENT-OBJECT:20:28METHOD:20NIL:20:28STRING:20T:29:29:29'></a>
...
<a id='x:28MGL-PAX:FIND-SOURCE:20GENERIC-FUNCTION:29'></a>

- [generic-function] **FIND-SOURCE** *OBJECT*

    Like `SWANK:FIND-DEFINITION-FOR-THING`, but this one
    ...
    behind the M-. extension (see [Emacs Integration][9a25]).
...
<a id='x:28MGL-PAX::40PAX-REFERENCE-BASED-EXTENSIONS:20MGL-PAX:SECTION:29'></a>

### 9.3 Reference Based Extensions

Let's see how to extend [`DOCUMENT`][1eb8] and M-. navigation if there is no
first class object to represent the thing of interest. Recall that
[`LOCATE`][b2be] returns a [`REFERENCE`][cc37] object in this case. [`DOCUMENT-OBJECT`][a05e] and
[`FIND-SOURCE`][b417] defer to [`LOCATE-AND-DOCUMENT`][6c17] and [`LOCATE-AND-FIND-SOURCE`][e9e9]
which have [`LOCATIVE-TYPE`][966a] in their argument list for `EQL` specializing
pleasure. Here is a stripped down example of how the [`VARIABLE`][474c]
locative is defined:
...
<a id='x:28MGL-PAX:COLLECT-REACHABLE-OBJECTS:20:28METHOD:20NIL:20:28MGL-PAX:REFERENCE:29:29:29'></a>
...
<a id='x:28MGL-PAX:LOCATE-AND-COLLECT-REACHABLE-OBJECTS:20GENERIC-FUNCTION:29'></a>
...
<a id='x:28MGL-PAX:LOCATE-AND-COLLECT-REACHABLE-OBJECTS:20:28METHOD:20NIL:20:28T:20T:20T:29:29:29'></a>
...
<a id='x:28MGL-PAX:DOCUMENT-OBJECT:20:28METHOD:20NIL:20:28MGL-PAX:REFERENCE:20T:29:29:29'></a>
...
<a id='x:28MGL-PAX:LOCATE-AND-DOCUMENT:20GENERIC-FUNCTION:29'></a>
...
<a id='x:28MGL-PAX:FIND-SOURCE:20:28METHOD:20NIL:20:28MGL-PAX:REFERENCE:29:29:29'></a>
...
<a id='x:28MGL-PAX:LOCATE-AND-FIND-SOURCE:20GENERIC-FUNCTION:29'></a>
...
<a id='x:28MGL-PAX:LOCATE-AND-FIND-SOURCE:20:28METHOD:20NIL:20:28T:20T:20T:29:29:29'></a>
...
<a id='x:28MGL-PAX:DEFINE-SYMBOL-LOCATIVE-TYPE:20MGL-PAX:MACRO:29'></a>
...
<a id='x:28MGL-PAX:DEFINE-DEFINER-FOR-SYMBOL-LOCATIVE-TYPE:20MGL-PAX:MACRO:29'></a>
...
<a id='x:28MGL-PAX::40PAX-SECTIONS:20MGL-PAX:SECTION:29'></a>
...
<a id='x:28MGL-PAX:SECTION:20CLASS:29'></a>
...
<a id='x:28MGL-PAX:SECTION-NAME:20:28MGL-PAX:READER:20MGL-PAX:SECTION:29:29'></a>
...
<a id='x:28MGL-PAX:SECTION-TITLE:20:28MGL-PAX:READER:20MGL-PAX:SECTION:29:29'></a>

- [reader] **SECTION-TITLE** *SECTION*

    Used in generated documentation.

<a id='x:28MGL-PAX:SECTION-ENTRIES:20:28MGL-PAX:READER:20MGL-PAX:SECTION:29:29'></a>
...
<a id='x:28DESCRIBE-OBJECT:20:28METHOD:20NIL:20:28MGL-PAX:SECTION:20T:29:29:29'></a>

- [method] **DESCRIBE-OBJECT** *(SECTION SECTION) STREAM*

    [`SECTION`][aee8] objects are printed by calling [`DOCUMENT`][1eb8] on them
    with all [Documentation Printer Variables][2eba], except for
    [`*DOCUMENT-NORMALIZE-PACKAGES*`][353f], turned off to reduce clutter.

  [0411]: #x:28MGL-PAX::40PAX-NEW-OBJECT-TYPES:20MGL-PAX:SECTION:29 "(MGL-PAX:@PAX-NEW-OBJECT-TYPES MGL-PAX:SECTION)"
  [0412]: #x:28MGL-PAX:REFERENCE-OBJECT:20:28MGL-PAX:READER:20MGL-PAX:REFERENCE:29:29 "(MGL-PAX:REFERENCE-OBJECT (MGL-PAX:READER MGL-PAX:REFERENCE))"
  [16ad]: #x:28PACKAGE:20MGL-PAX:LOCATIVE:29 "(PACKAGE MGL-PAX:LOCATIVE)"
  [1920]: #x:28MGL-PAX:COLLECT-REACHABLE-OBJECTS:20GENERIC-FUNCTION:29 "(MGL-PAX:COLLECT-REACHABLE-OBJECTS GENERIC-FUNCTION)"
  [1eb8]: #x:28MGL-PAX:DOCUMENT:20FUNCTION:29 "(MGL-PAX:DOCUMENT FUNCTION)"
  [1f66]: #x:28MGL-PAX:SECTION-ENTRIES:20:28MGL-PAX:READER:20MGL-PAX:SECTION:29:29 "(MGL-PAX:SECTION-ENTRIES (MGL-PAX:READER MGL-PAX:SECTION))"
  [2200]: #x:28MGL-PAX::40PAX-BASICS:20MGL-PAX:SECTION:29 "(MGL-PAX:@PAX-BASICS MGL-PAX:SECTION)"
  [2285]: #x:28MGL-PAX:LOCATE-ERROR:20CONDITION:29 "(MGL-PAX:LOCATE-ERROR CONDITION)"
  [23ee]: #x:28MGL-PAX::40PAX-TUTORIAL:20MGL-PAX:SECTION:29 "(MGL-PAX:@PAX-TUTORIAL MGL-PAX:SECTION)"
  [24fc]: #x:28MGL-PAX:CANONICAL-REFERENCE:20GENERIC-FUNCTION:29 "(MGL-PAX:CANONICAL-REFERENCE GENERIC-FUNCTION)"
  [2863]: #x:28MGL-PAX:DEFSECTION:20MGL-PAX:MACRO:29 "(MGL-PAX:DEFSECTION MGL-PAX:MACRO)"
  [2cf1]: #x:28MGL-PAX:SECTION:20MGL-PAX:LOCATIVE:29 "(MGL-PAX:SECTION MGL-PAX:LOCATIVE)"
  [2eba]: #x:28MGL-PAX::40PAX-DOCUMENTATION-PRINTER-VARIABLES:20MGL-PAX:SECTION:29 "(MGL-PAX:@PAX-DOCUMENTATION-PRINTER-VARIABLES MGL-PAX:SECTION)"
  [3023]: #x:28FUNCTION:20MGL-PAX:LOCATIVE:29 "(FUNCTION MGL-PAX:LOCATIVE)"
  [353f]: #x:28MGL-PAX::2ADOCUMENT-NORMALIZE-PACKAGES:2A:20VARIABLE:29 "(MGL-PAX:*DOCUMENT-NORMALIZE-PACKAGES* VARIABLE)"
  [36e1]: #x:28MGL-PAX::40PAX-SECTIONS:20MGL-PAX:SECTION:29 "(MGL-PAX:@PAX-SECTIONS MGL-PAX:SECTION)"
  [3fef]: #x:28MGL-PAX::2ADOCUMENT-LINK-SECTIONS:2A:20VARIABLE:29 "(MGL-PAX:*DOCUMENT-LINK-SECTIONS* VARIABLE)"
  [474c]: #x:28VARIABLE:20MGL-PAX:LOCATIVE:29 "(VARIABLE MGL-PAX:LOCATIVE)"
  [4918]: #x:28:22mgl-pax:22:20ASDF:2FSYSTEM:SYSTEM:29 "(\"mgl-pax\" ASDF/SYSTEM:SYSTEM)"
  [57cb]: #x:28MGL-PAX:DEFINE-SYMBOL-LOCATIVE-TYPE:20MGL-PAX:MACRO:29 "(MGL-PAX:DEFINE-SYMBOL-LOCATIVE-TYPE MGL-PAX:MACRO)"
  [5a7b]: #x:28MGL-PAX::40PAX-MARKDOWN-INDENTATION:20MGL-PAX:SECTION:29 "(MGL-PAX:@PAX-MARKDOWN-INDENTATION MGL-PAX:SECTION)"
  [62d4]: #x:28MGL-PAX:DEFINE-LOCATIVE-TYPE:20MGL-PAX:MACRO:29 "(MGL-PAX:DEFINE-LOCATIVE-TYPE MGL-PAX:MACRO)"
  [68e7]: #x:28MGL-PAX:DEFINE-DEFINER-FOR-SYMBOL-LOCATIVE-TYPE:20MGL-PAX:MACRO:29 "(MGL-PAX:DEFINE-DEFINER-FOR-SYMBOL-LOCATIVE-TYPE MGL-PAX:MACRO)"
  [6c17]: #x:28MGL-PAX:LOCATE-AND-DOCUMENT:20GENERIC-FUNCTION:29 "(MGL-PAX:LOCATE-AND-DOCUMENT GENERIC-FUNCTION)"
  [6e37]: #x:28CLASS:20MGL-PAX:LOCATIVE:29 "(CLASS MGL-PAX:LOCATIVE)"
  [76b5]: #x:28MGL-PAX:LOCATIVE:20MGL-PAX:LOCATIVE:29 "(MGL-PAX:LOCATIVE MGL-PAX:LOCATIVE)"
  [7a11]: #x:28MGL-PAX:LOCATE-AND-COLLECT-REACHABLE-OBJECTS:20GENERIC-FUNCTION:29 "(MGL-PAX:LOCATE-AND-COLLECT-REACHABLE-OBJECTS GENERIC-FUNCTION)"
  [8082]: #x:28MGL-PAX::2ADOCUMENT-LINK-CODE:2A:20VARIABLE:29 "(MGL-PAX:*DOCUMENT-LINK-CODE* VARIABLE)"
  [819a]: #x:28MGL-PAX:REFERENCE-LOCATIVE:20:28MGL-PAX:READER:20MGL-PAX:REFERENCE:29:29 "(MGL-PAX:REFERENCE-LOCATIVE (MGL-PAX:READER MGL-PAX:REFERENCE))"
  [81be]: #x:28MGL-PAX:LOCATE-ERROR-MESSAGE:20:28MGL-PAX:READER:20MGL-PAX:LOCATE-ERROR:29:29 "(MGL-PAX:LOCATE-ERROR-MESSAGE (MGL-PAX:READER MGL-PAX:LOCATE-ERROR))"
  [8b71]: #x:28MGL-PAX::40PAX-MARKDOWN-SYNTAX-HIGHLIGHTING:20MGL-PAX:SECTION:29 "(MGL-PAX:@PAX-MARKDOWN-SYNTAX-HIGHLIGHTING MGL-PAX:SECTION)"
  [8be2]: #x:28MGL-PAX::2ADOCUMENT-UPPERCASE-IS-CODE:2A:20VARIABLE:29 "(MGL-PAX:*DOCUMENT-UPPERCASE-IS-CODE* VARIABLE)"
  [8e44]: #x:28MGL-PAX::40PAX-EXTENSION-API:20MGL-PAX:SECTION:29 "(MGL-PAX:@PAX-EXTENSION-API MGL-PAX:SECTION)"
  [90f2]: #x:28ASDF:2FSYSTEM:SYSTEM:20MGL-PAX:LOCATIVE:29 "(ASDF/SYSTEM:SYSTEM MGL-PAX:LOCATIVE)"
  [966a]: #x:28MGL-PAX:LOCATIVE-TYPE:20FUNCTION:29 "(MGL-PAX:LOCATIVE-TYPE FUNCTION)"
  [96c5]: #x:28MGL-PAX:EXPORTABLE-LOCATIVE-TYPE-P:20GENERIC-FUNCTION:29 "(MGL-PAX:EXPORTABLE-LOCATIVE-TYPE-P GENERIC-FUNCTION)"
  [9a25]: #x:28MGL-PAX::40PAX-EMACS-INTEGRATION:20MGL-PAX:SECTION:29 "(MGL-PAX:@PAX-EMACS-INTEGRATION MGL-PAX:SECTION)"
  [9f14]: #x:28MGL-PAX::40PAX-LOCATIVE-TYPES:20MGL-PAX:SECTION:29 "(MGL-PAX:@PAX-LOCATIVE-TYPES MGL-PAX:SECTION)"
  [a05e]: #x:28MGL-PAX:DOCUMENT-OBJECT:20GENERIC-FUNCTION:29 "(MGL-PAX:DOCUMENT-OBJECT GENERIC-FUNCTION)"
  [a741]: #x:28MGL-PAX::40PAX-LOCATIVES-AND-REFERENCES:20MGL-PAX:SECTION:29 "(MGL-PAX:@PAX-LOCATIVES-AND-REFERENCES MGL-PAX:SECTION)"
  [a90e]: #x:28MGL-PAX::40PAX-MARKDOWN-SUPPORT:20MGL-PAX:SECTION:29 "(MGL-PAX:@PAX-MARKDOWN-SUPPORT MGL-PAX:SECTION)"
  [acc9]: #x:28MGL-PAX:LOCATE-OBJECT:20GENERIC-FUNCTION:29 "(MGL-PAX:LOCATE-OBJECT GENERIC-FUNCTION)"
  [aee8]: #x:28MGL-PAX:SECTION:20CLASS:29 "(MGL-PAX:SECTION CLASS)"
  [b2be]: #x:28MGL-PAX:LOCATE:20FUNCTION:29 "(MGL-PAX:LOCATE FUNCTION)"
  [b417]: #x:28MGL-PAX:FIND-SOURCE:20GENERIC-FUNCTION:29 "(MGL-PAX:FIND-SOURCE GENERIC-FUNCTION)"
  [c98c]: #x:28MGL-PAX:DEFINE-PACKAGE:20MGL-PAX:MACRO:29 "(MGL-PAX:DEFINE-PACKAGE MGL-PAX:MACRO)"
  [cc37]: #x:28MGL-PAX:REFERENCE:20CLASS:29 "(MGL-PAX:REFERENCE CLASS)"
  [d259]: #x:28MGL-PAX::2ADISCARD-DOCUMENTATION-P:2A:20VARIABLE:29 "(MGL-PAX:*DISCARD-DOCUMENTATION-P* VARIABLE)"
  [d71c]: #x:28METHOD:20MGL-PAX:LOCATIVE:29 "(METHOD MGL-PAX:LOCATIVE)"
  [d7eb]: #x:28MGL-PAX:DOCUMENT-OBJECT:20:28METHOD:20NIL:20:28STRING:20T:29:29:29 "(MGL-PAX:DOCUMENT-OBJECT (METHOD NIL (STRING T)))"
  [d8db]: #x:28TYPE:20MGL-PAX:LOCATIVE:29 "(TYPE MGL-PAX:LOCATIVE)"
  [dee3]: #x:28MGL-PAX::40PAX-BACKGROUND:20MGL-PAX:SECTION:29 "(MGL-PAX:@PAX-BACKGROUND MGL-PAX:SECTION)"
  [df39]: #x:28DESCRIBE-OBJECT:20:28METHOD:20NIL:20:28MGL-PAX:SECTION:20T:29:29:29 "(DESCRIBE-OBJECT (METHOD NIL (MGL-PAX:SECTION T)))"
  [e0d7]: #x:28MGL-PAX:RESOLVE:20FUNCTION:29 "(MGL-PAX:RESOLVE FUNCTION)"
  [e9e9]: #x:28MGL-PAX:LOCATE-AND-FIND-SOURCE:20GENERIC-FUNCTION:29 "(MGL-PAX:LOCATE-AND-FIND-SOURCE GENERIC-FUNCTION)"
  [f3b7]: #x:28MGL-PAX:LOCATE-ERROR:20FUNCTION:29 "(MGL-PAX:LOCATE-ERROR FUNCTION)"
  [ff65]: #x:28MGL-PAX::40PAX-REFERENCE-BASED-EXTENSIONS:20MGL-PAX:SECTION:29 "(MGL-PAX:@PAX-REFERENCE-BASED-EXTENSIONS MGL-PAX:SECTION)"
