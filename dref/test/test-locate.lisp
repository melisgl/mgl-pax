...
(deftest test-locate/compiler-macro ()
  ...
  (check-ref (dref '(setf has-setf-function) 'compiler-macro)
...
(deftest test-locate/setf ()
  ...
  (check-ref (dref 'has-setf-expander 'setf) 'has-setf-expander 'setf)
...
(deftest test-locate/setf-function ()
  (check-ref (dref '(setf has-setf-function) 'function)
             '(setf has-setf-function) 'function)
  (check-ref (locate #'(setf has-setf-function))
             '(setf has-setf-function) 'function)
  (is (eq (resolve (xref '(setf has-setf-function) 'function) nil)
...
(deftest test-locate/setf-generic-function ()
  (check-ref (dref '(setf has-setf-generic-function) 'generic-function)
             '(setf has-setf-generic-function) 'generic-function)
  (check-ref (locate #'(setf has-setf-generic-function))
             '(setf has-setf-generic-function) 'generic-function)
  (is (eq (resolve (xref '(setf has-setf-generic-function) 'generic-function)
                   nil)
...
(deftest test-locate/setf-method ()
  (check-ref (dref '(setf has-setf-generic-function)
                   '(method () (string)))
             '(setf has-setf-generic-function) '(method () (string)))
  (check-ref (locate (dref::find-method* '(setf has-setf-generic-function)
                                         () '(string)))
             '(setf has-setf-generic-function) '(method () (string)))
  (signals (locate-error :pred "Method does not exist.")
    (dref '(setf has-setf-generic-function) '(method () (undefined))))
  (is (eq (resolve (xref '(setf has-setf-generic-function)
                         '(method () (string)))
                   nil)
