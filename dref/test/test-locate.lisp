...
(deftest test-locate/constant ()
  ...
  (check-ref (dref-origin (dref 'bar '(variable 7))) 'bar '(constant 7) 'xref)
...
(deftest test-locate/setf/function ()
  (check-ref (dref 'has-setf-function 'setf) 'has-setf-function 'setf)
  (check-ref (locate #'(setf has-setf-function)) 'has-setf-function 'setf)
