...
* TODO should PAX::MAP-NAMES-IN-RAW list instead of find the first?
This would make 'mgl-pax' refer to "MGL-PAX" package even if there is
an "mgl-pax" asdf:system.
