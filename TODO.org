...
the noise sections in MGL-PAX-TEST argue against this idea.
* MAYBE add "also exported from" to "see home package xxx"
* MAYBE when exported by pax, we know the exact definition being exported
The package apropos could take advantage?
