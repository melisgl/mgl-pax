...
* BUG method dspec parsing is incorrect
...
* BUG html page title has markup
E.g \\, maybe **.
* BUG (3BMD-GRAMMAR:PARSE-DOC "[l][*x*]") fails
* BUG C-. on [lambda lists][clhs] confused by the space
