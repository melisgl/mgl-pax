...
* TODO support list names such as (SETF FOO-A) in M-., C-., etc
** PAX::MAP-NAMES-IN-RAW only knows about symbol and string names:

MGL-PAX-TEST> (pax::definitions-of-wall
               '(("foo" ("function"))))
(#<DREF FOO FUNCTION>)
MGL-PAX-TEST> (pax::definitions-of-wall
               '(("(setf has-setf-function)"
                  ("function"))))
NIL
** READ-FUNNY needs to support list names too
