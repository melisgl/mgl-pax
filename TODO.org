...
* (dref::function-arg-names (dref:arglist (dref:locate 'CL-PPCRE:SCAN '(METHOD NIL (FUNCTION T)))))
* transcript errors not caught properly
* auto-escape headings in docstrings
