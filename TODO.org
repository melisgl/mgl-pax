...
** MAYBE DEFINE-DEFINITION-CLASS shouldn't even exist but be incorporated into DEFINE-LOCATIVE-TYPE?
Apart from the syntactic difference, SUPERCLASSES would be expressed
in terms of locative types, not classes, and SUPERCLASSES would be
determined from that.

Do all have definition classes? No, some of the pseudo don't.
